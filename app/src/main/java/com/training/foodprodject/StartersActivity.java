...
public class StartersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] dishes = {
                ...
                new Dish("Egg and avocado uramaki", "Pasta in a sauce made from free range eggs and fresh avacoda", 1199),
                ...
                new Dish("Spinach and cabbage wontons", "This wonton cases Stuffed with fresh spinach and chinese cabbage", 799),
                new Dish("Broccoli and cucumber soup", "A dip made from scotch bonnet chilli and fresh aubergine", 999),
