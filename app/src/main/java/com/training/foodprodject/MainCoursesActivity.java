package com.training.foodprodject;
...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Dish[] mainCourses = {
                new Dish("Black paper and chickpea vindaloo", "Hot vindaloo made with hot black pepper anf fresh chickpea", 1399),
                new Dish("Goji berry and cauliflower salad ", "A crisp salad featuring fresh goji berry and cauliflower", 1299),
                new Dish("Thai basil and mulberry salad", " A crisp salad featuring fresh tahi basil and mulberry",1499),
                ...
                new Dish("Samphire and rocket salad ","Samphire and fresh rocket server on a bed of lettuce", 1599),
                new Dish("Cocoa and chicory salad ","Cocoa and chicory served a bed lettuce",1699 ),
